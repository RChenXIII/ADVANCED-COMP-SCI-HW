...
public class Rectangle extends Shape {
    ...
    public void draw(Graphics g) {
        ...
        g2D.setPaint(fill); // sets the paint color
        g2D.fillRect(xCoord[0], yCoord[0], length, width); // draws a rectangle (filled in)

        Color stroke = (strokeColor != null) ? strokeColor : Color.red;
        g2D.setPaint(stroke); // sets the paint color
