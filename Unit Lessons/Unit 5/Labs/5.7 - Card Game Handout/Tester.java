...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // demonstrate deck validation and builder
            System.out.println("\n== DECK VALIDATOR DEMO ==");
            ...
            System.out.println("\nYou can build a custom deck now (5 cards).\n");
            ArrayList<Card> userDeck = DeckValidator.buildUserDeck(sc);
            System.out.println("Your deck:");
            for (Card c : userDeck) {
                System.out.println("  " + c);
            }
            System.out.println("Valid? " + DeckValidator.isValidDeck(userDeck));
            sc.close();
        } catch (Throwable t) {
