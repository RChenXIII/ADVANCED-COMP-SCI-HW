public class DogTester {
    public static void main(String[] args) {
        ...
        System.out.println("testDog2 with modified char: " + PawesomeUtils.validateDogTag(testDog2));

        System.out.println("\n=== Testing checkIn() with Invalid Tag ===");

        Dog counterfeitDog = new Dog("Fake", "BadGuy", 3, 555, false);
        counterfeitDog.setDogTag("FAKE123");
        PawesomeUtils.checkIn(counterfeitDog, "BadGuy");
        
  
        Dog validDog = new Dog("Buddy", "Alice", 4, 321, false);
        PawesomeUtils.checkIn(validDog, "Alice");

        System.out.println("\n=== Testing convertAgeToHumanAge() ===");

        Dog puppy = new Dog("Puppy", "Owner1", 1, 111, true);
        Dog youngDog = new Dog("Young", "Owner2", 2, 222, true);
        Dog olderDog = new Dog("Older", "Owner3", 5, 333, true);
        ...
        System.out.println("Human age 30 = " + PawesomeUtils.convertAgeToDogYears(30) + " dog years");
        System.out.println("Human age 39 = " + PawesomeUtils.convertAgeToDogYears(39) + " dog years");
        System.out.println("Human age 49 = " + PawesomeUtils.convertAgeToDogYears(49) + " dog years");
        System.out.println("Human age 60 = " + PawesomeUtils.convertAgeToDogYears(60) + " dog years");
    }
}